...
class GitLabClient:
        ...
        if self._client is None:
            ...
            try:
                self._client = gitlab.Gitlab(
                    url=self.base_url, private_token=self.private_token, timeout=5, ssl_verify=False
                )
    ...
    def _request(self, method, endpoint, params=None):
        ...
        def make_request():
            response = _SESSION.request(method, url, headers=self.headers, params=params, timeout=30, verify=False)
