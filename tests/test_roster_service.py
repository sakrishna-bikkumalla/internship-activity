...
def test_get_all_members_with_teams_multiple(db_session):
    ...
    roster_service.add_or_update_member(db_session, {"gitlab_username": "u1", "name": "N1", "team_name": "T1"}, batch.id)
    roster_service.add_or_update_member(db_session, {"gitlab_username": "u2", "name": "N2", "team_name": "T1"}, batch.id)
...
def test_get_all_teams_with_members(db_session):
    ...
    roster_service.add_or_update_member(db_session, {"gitlab_username": "u1", "name": "N1", "team_name": "Team Alpha"}, batch.id)
...
def test_get_all_teams(db_session):
    ...
    roster_service.add_or_update_member(db_session, {"gitlab_username": "u1", "name": "N1", "team_name": "Team Beta"}, batch.id)
