...
def make_fake_st(text_inputs, mode):
    class Spinner:
    ...
    class Sidebar:
        ...
        def text_input(self, label, value=None, type=None, placeholder=None):
            # Return in order for URL and token inputs and username entry
    ...
    class FakeSt:
        def __init__(self, text_inputs, mode):
            self.sidebar = Sidebar(text_inputs, mode)
        ...
        def text_input(self, label, placeholder=None):
            # User profile text input is independent of sidebar.
            if self.sidebar._text_inputs:
                return self.sidebar._text_inputs.pop(0)
            return ""
    ...
    return FakeSt(text_inputs, mode)
